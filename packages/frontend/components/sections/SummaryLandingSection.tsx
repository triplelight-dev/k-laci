...
const cardData = [
  [
    ...
    { title: "유형별\n종합순위", desc: "개발도약형, 기초안정형, 안정생활형 등 \n16개 유형별 종합순위", bgImage: '/summary/Ranking-3.png', link: INTERNAL_LINKS.SUMMARY.KLACI_TYPE_RANK },
    { title: "광역별\n종합순위", desc: "강원, 경기, 경남, 경북, 광주 등\n17개 광역별 종합순위", bgImage: '/summary/Ranking-4.png', link: INTERNAL_LINKS.SUMMARY.REGIONAL_RANKING },
  ],
  [
