...
const FooterTopSection = () => {
  ...
  // 저작권 텍스트를 배열로 정의
  const MIDDLE_TEXT = [
    '상호명: 트리플라잇 주식회사 | 대표자: 이은화, 정유진',
    '사업자번호: 5258801428 | 통신판매업신고번호: 제 2025-서울중구-1608 호',
    '주소: 서울 중구 삼일대로 308(충무로 2가), 15층 1502호',
    '',
    '영업시간: 09:00 AM - 19:00 PM',
    '이메일: klaci@triplelight.co |  전화번호: 02-706-8818'
  ];
