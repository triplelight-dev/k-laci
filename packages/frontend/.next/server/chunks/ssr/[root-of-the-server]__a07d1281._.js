...
const createDistrictSlice = (set, get)=>({
        ...
        initializeData: async ()=>{
            try {
                const [provinceData, regionsData] = await Promise.all([
                    __turbopack_context__.r("[project]/packages/frontend/data/province_data.json (json, async loader)")(__turbopack_context__.i),
                    __turbopack_context__.r("[project]/packages/frontend/data/regions_data.json (json, async loader)")(__turbopack_context__.i)
                ]);
                set((state)=>({
                        district: {
                            ...state.district,
                            provinces: provinceData.default,
        ...
        getProvinceById: (id)=>{
            ...
            console.log('District state:', currentState.district);
            console.log('Provinces:', currentState.district?.provinces);
            // 안전하게 provinces 배열에 접근
            const provinces = currentState.district?.provinces || [];
            console.log('Safe provinces array:', provinces);
            const foundProvince = provinces.find((province)=>province.id === id);
        ...
        getRegionById: (id)=>{
            const currentState = get();
            // 안전하게 regions 배열에 접근
            const regions = currentState.district?.regions || [];
...
const DistrictSelectSection = ({ isFloating = false })=>{
    ...
    const districtOptions = selectedProvince ? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$frontend$2f$data$2f$regions_data$2e$json__$28$json$29$__["default"].filter((region)=>region.province_id === Number(selectedProvince)).map((region)=>({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        ...
        children: [
          ...
          `
            ...
            !isJewel && hoveredArea && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("rect", {
                        x: center - 50,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a07d1281._.js.map