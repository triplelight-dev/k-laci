...
(()=>{
    const e = new Error("Cannot find module '@/data/regions_data.json'");
...
const DistrictSelectSection = ({ isFloating = false })=>{
    ...
    const districtOptions = selectedProvince ? regionsData.filter((region)=>region.province_id === Number(selectedProvince)).map((region)=>({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6d70579._.js.map